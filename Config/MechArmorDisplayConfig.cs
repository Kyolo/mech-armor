...
namespace MechArmor.Config
{
    public class MechArmorDisplayConfig : ModConfig
    {
        ...
        [Label("Default X position of the state indicator."), Tooltip("From left to right and in pixels, starting at 0."), DefaultValue(1000), Range(0, 4096)]
        public int DefaultArmorStatusPositionX;
        [Label("Default Y position of the state indicator."), Tooltip("From top to bottom and in pixels, starting at 0."), DefaultValue(0), Range(0, 4096)]
